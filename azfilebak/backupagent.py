...
class BackupAgent(object):
    ...
    def get_notification_message(self, is_full, start_timestamp, end_timestamp, success, blob_size, blob_path, error_msg):
        ...
        data = {
            ...
            "timestamp-send": str(Timing.local_string_to_utc_epoch(Timing.now_localtime())),
            "timestamp-last-successful": str(Timing.local_string_to_utc_epoch(start_timestamp)),
            "timestamp-bkp-begin": str(Timing.local_string_to_utc_epoch(start_timestamp)),
            "timestamp-bkp-end": str(Timing.local_string_to_utc_epoch(end_timestamp)),
